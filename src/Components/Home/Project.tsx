...
import Dltbbtrial from "../../Assets/Images/ProjectImg/dltbbtrial.png";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contents}>
        <ProjectModal />
        <ProjectCard
          projectImg={Dltbbtrial}
          projectName="DLTBB trial"
          projectDes="삼성 서울 병원 및 해외 다기관 대상 연구에 사용 될 환자의 선행항암치료 (Neoadjuvant treatment) 여부에 따른 환자군 그룹 배정 및 데이터 등록, 수집 플랫폼 입니다."
          gitLink="https://github.com/G-jjunny/Questionnaire"
          siteLink="https://dltbbtrial.com/"
          skills={[
            "React",
            "TypeScript",
            "ViteJS",
          ...
          description={[
            "이 프로젝트는 삼성 서울 병원 및 다양한 기관에서 외국인 환자 데이터를 효율적으로 수집·관리할 수 있는 외국인 환자 그룹 배정 관리 시스템입니다. 사용자는 소속 기관에 따라 역할 기반으로 데이터를 조회·추가할 수 있으며, 관리자(ADMIN)는 전체 데이터를 조회, 수정, 엑셀 파일로 다운로드할 수 있습니다.",
          ]}
        />
        <ProjectCard
        ...
        <ProjectCard
          ...
          skills={["React"]}
          description={[
            `학부시절 산학협력 프로젝트이며 신광자동차 공업소 홍보 사이트로 현재 서비스중인 사이트입니다. React와 styled-components 등으로 구현하였으며 기능으로는 email.js를 이용한 이메일 전송 기능을 구현하였습니다.`,
          ]}
        />
        <ProjectCard
          projectImg={SMU}
